      ...
      <div class="p-6 border-b border-gray-200 bg-white">
        <div class="flex items-center justify-between mb-4">
          <div>
            ...
            <p class="text-gray-600">Manage returns to suppliers</p>
          </div>
          <button
      ...
      <div class="flex-1 overflow-y-auto p-6">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      <div class="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-3">
                        <lucide-icon [img]="returnIcon" class="w-5 h-5 text-purple-600"></lucide-icon>
                      </div>
                      <div>
                        <div class="text-sm font-medium text-gray-900">{{ return.productName }}</div>
                        <div class="text-sm text-gray-500">Purchase: {{ return.purchaseId }}</div>
                      </div>
                    </div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
          ...
          <div *ngIf="filteredReturns().length === 0" class="text-center py-12">
            ...
            <p class="text-gray-500">No purchase returns match your current filters</p>
          </div>
        </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-2xl font-bold text-gray-900">{{ inventoryService.allPurchaseReturns().length }}</p>
              </div>
      ...
      <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div class="p-6 border-b border-gray-200">
          <h3 class="text-xl font-bold text-gray-900">
            {{ editingReturn() ? 'Edit Purchase Return' : 'Return to Supplier' }}
          </h3>
        </div>
        ...
        <form (ngSubmit)="saveReturn()" class="p-6 space-y-4">
          ...
          <div class="flex gap-3 pt-4">
            <button
              type="submit"
              class="flex-1 bg-purple-600 hover:bg-purple-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors duration-200"
            >
