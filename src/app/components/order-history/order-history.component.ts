    ...
    <div class="h-full flex flex-col">
      ...
      <div class="flex-1 overflow-y-auto p-6">
        <div *ngIf="posService.allOrders().length === 0" class="text-center py-12">
          ...
          <p class="text-gray-500">Complete some orders to see them in the history</p>
        </div>
        ...
        <div class="space-y-4">
          ...
          >
            ...
            <!-- Customer Info -->
            <div *ngIf="order.customerName" class="flex items-center gap-2 mb-4 text-sm text-gray-600">
            ...
            <div class="mt-4 pt-4 border-t border-gray-200">
              ...
              <div *ngIf="order.discount > 0" class="flex justify-between text-sm text-green-600 mb-1">
                <span>Discount:</span>
